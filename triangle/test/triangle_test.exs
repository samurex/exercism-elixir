defmodule TriangleTest do
  ...
  @tag :pending
  test "degenrate triangle has sum of first two sides equal to third" do
    assert Triangle.kind(2, 2, 4) == :degenerate
  end

  test "degenrate triangle has sum of last two sides equal to first" do
    assert Triangle.kind(8, 4, 4) == :degenerate
  end

  test "degenrate triangle has sum of first and last side equal to middle" do
    assert Triangle.kind(5, 10, 5) == :degenerate
  end
end
